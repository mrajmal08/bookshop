    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption d-md-block">
                <h1 class="animated wow fadeInDown hero-heading" data-wow-delay=".4s">Welcome to The Largest
                    Marketplace</h1>
                <p class="animated fadeInUp wow hero-sub-heading" data-wow-delay=".6s">Buy and sell everything from used
                    cars to mobile phones and computers, or search for property, jobs and more</p>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-md-block">
                ...
                <p class="animated wow fadeInRight hero-sub-heading" data-wow-delay=".9s">Buy and sell everything from
                    used cars to mobile phones and computers, or search for property, jobs and more</p>
            </div>
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="assets/img/slider/slider-bg3.jpg" alt="Third slide">
            <div class="carousel-caption d-md-block">
                <h1 class="animated wow fadeInDown hero-heading" data-wow-delay=".6s">Get More Sell and More
                    Exposure</h1>
                <p class="animated fadeInUp wow hero-sub-heading" data-wow-delay=".8s">Buy and sell everything from used
                    cars to mobile phones and computers, or search for property, jobs and more</p>
            </div>
        </div>
    </div>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
                <div class="featured-box">
                    ...
                    <div class="feature-content">
                        ...
                        <h4><a href="ads-details.php">Canon SX Powershot ...</a></h4>
                        <div class="meta-tag">
<span>
...
<a href="#"><i class="lni-tag"></i> Canon</a>
                        ...
                        <div class="listing-bottom">
                            ...
                            <a href="ads-details.php" class="btn btn-common float-right">View Details</a>
                        </div>
                    </div>
                </div>
            </div>
...
25% Save
                    ...
                    <div class="feature-content">
                        ...
                        <h4><a href="ads-details.php">Apple Macbook Pro ...</a></h4>
                        <div class="meta-tag">
<span>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
                <div class="featured-box">
                    ...
                    <div class="feature-content">
                        ...
                        <h4><a href="ads-details.php">Mercedes Benz E200 ...</a></h4>
                        <div class="meta-tag">
<span>
...
10% Save
                    ...
                    <div class="feature-content">
                        ...
                        <h4><a href="ads-details.php">Brown Leather Bag ...</a></h4>
                        <div class="meta-tag">
<span>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4">
                <div class="featured-box">
                    ...
                    <div class="feature-content">
                        ...
                        <h4><a href="ads-details.php">Iphonex 6 Plus Factor ...</a></h4>
                        <div class="meta-tag">
<span>
...
35% Save
                    ...
                    <div class="feature-content">
                        ...
                        <h4><a href="ads-details.php">Wooden Dining Tabl ...</a></h4>
                        <div class="meta-tag">
<span>
<a href="#"><i class="lni-user"></i> John Smith</a>
</span>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <a href="category.php" class="img-box">
            ...
            <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
                ...
                <div class="blog-item-wrapper">
                    ...
                    <div class="blog-item-text">
                        ...
                        <h3>
                            <a href="single-post.php">How to get more ad views</a>
                        </h3>
                        <p>
                            Reprehenderit nemo quod tempore doloribus ratione distinctio quis quidem vitae sunt
                            reiciendis, molestias omnis soluta.
            ...
            <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
                ...
                <div class="blog-item-wrapper">
                    ...
                    <div class="blog-item-text">
                        ...
                        <h3>
                            <a href="single-post.php">Writing a better product description</a>
                        </h3>
                        <p>
                            Reprehenderit nemo quod tempore doloribus ratione distinctio quis quidem vitae sunt
                            reiciendis, molestias omnis soluta.
